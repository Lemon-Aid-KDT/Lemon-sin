...
class _CameraScreenState extends State<CameraScreen>
  ...
  void _analyze() {
    ...
    // 백엔드 OCR 분석 트리거 — ProviderScope.containerOf 로 StatefulWidget 에서 호출.
    // (CameraScreen 을 ConsumerStatefulWidget 으로 바꾸지 않고 ref 접근하는 패턴.)
    final container = ProviderScope.containerOf(context, listen: false);
    container.read(analysisProvider.notifier).analyzeImage(captured, mode: modeArg);
