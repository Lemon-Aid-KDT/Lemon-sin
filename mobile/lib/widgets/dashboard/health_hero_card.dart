          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: AppSpace.sm),
                _MacroPill(label: '단', pct: widget.proteinPct, color: _kProtein),
                const SizedBox(width: AppSpace.sm),
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: _MacroBar(
                      label: '순탄수', value: widget.carbG,
                      target: widget.carbTargetG, color: _kCarb,
                      progress: _gauge,
                    ),
                  ),
                  ...
                  Expanded(
                    child: _MacroBar(
                      label: '단백질', value: widget.proteinG,
                      target: widget.proteinTargetG, color: _kProtein,
                      progress: _gauge,
                    ),
                  ),
                  const SizedBox(width: AppSpace.md),
                  Expanded(
                    child: _MacroBar(
                      label: '지방', value: widget.fatG,
                      target: widget.fatTargetG, color: _kFat,
                      progress: _gauge,
                    ),
                  ),
                ],
...
class _ThemeChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Pressable(
      ...
      child: Container(
        padding:
            const EdgeInsets.symmetric(horizontal: AppSpace.md, vertical: 7),
        decoration: BoxDecoration(
        ...
        child: Row(
          ...
          children: [
            Icon(Icons.auto_awesome_rounded,
                color: AppColor.brandDeep, size: 13),
            const SizedBox(width: 4),
            Text(
              '테마',
...
class _HalfGaugePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(
      rect, math.pi, math.pi * ratio.clamp(0.02, 1.0), false, progressPaint,
    );
  }
