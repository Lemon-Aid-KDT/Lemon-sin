  ...
  _CardColors _resolveColors() {
    switch (variant) {
      case LemonCardVariant.blue:
        return _CardColors(bg: LemonColors.brandSoft, accent: LemonColors.brand);
      case LemonCardVariant.lemon:
        return _CardColors(bg: LemonColors.citrusLight, accent: LemonColors.citrus);
      ...
      case LemonCardVariant.green:
        return _CardColors(bg: LemonColors.greenLight, accent: LemonColors.green);
