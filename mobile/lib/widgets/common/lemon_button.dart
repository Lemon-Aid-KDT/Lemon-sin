...
enum LemonButtonVariant { primary, secondary, ghost, danger, kakao, google, apple }
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        onTap: onPressed,
        borderRadius: BorderRadius.circular(LemonRadius.md),
        splashColor: colors.fg.withOpacity(0.08),
        highlightColor: colors.fg.withOpacity(0.04),
        child: button,
      ),
    );
  }
