        ...
        child: Material(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: const Color(0xFF141A2C).withOpacity(0.30),
                  blurRadius: 60,
                  spreadRadius: -10,
              ...
              children: [
                ...
                Row(
                  children: [
                    if (secondaryLabel != null) ...[
                      Expanded(
                        ...
                        child: _NeuInsetButton(
                          ...
                          color: dangerSecondary ? AppColor.danger : AppColor.inkSecondary,
                    ...
                    Expanded(
                      flex: secondaryLabel != null ? 6 : 10,    // Primary 약간 더 넓게 (6:4)
...
class _NeuInsetButton extends StatelessWidget {
  ...
  const _NeuInsetButton({required this.label, required this.color, required this.onPressed});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: AppColor.brand.withOpacity(0.55),
              blurRadius: 14,
              spreadRadius: -4,
...
class _AppBottomSheet extends StatelessWidget {
  ...
  const _AppBottomSheet({required this.title, this.subtitle, required this.items});
...
Future<void> showAppCelebrateDialog(
  ...
  return showGeneralDialog<void>(
    ...
    pageBuilder: (_, __, ___) => _AppCelebrate(
      title: title,
      body: body,
      primaryLabel: primaryLabel,
      icon: icon,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: const Color(0xFFE0AC00).withOpacity(0.55),
                              blurRadius: 24,
                              spreadRadius: -8,
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: AppColor.ink.withOpacity(0.40),
                                blurRadius: 18,
                                spreadRadius: -6,
