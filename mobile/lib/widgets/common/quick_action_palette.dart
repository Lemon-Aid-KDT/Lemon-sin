...
const List<_ActionSpec> _kActions = [
  _ActionSpec(QuickAction.manualInput, Icons.edit_rounded,
      '직접 입력', Color(0xFFFF6B6B)),
  _ActionSpec(QuickAction.water, Icons.water_drop_rounded,
      '물 섭취', Color(0xFF2CA8E0)),
  _ActionSpec(QuickAction.supplementShot, Icons.medication_rounded,
      '영양제 촬영', Color(0xFF22B07D)),
  _ActionSpec(QuickAction.mealShot, Icons.restaurant_rounded,
      '식단 촬영', Color(0xFFFF9500)),
  _ActionSpec(QuickAction.medication, Icons.check_circle_rounded,
      '복약 기록', Color(0xFF4D7BFF)),
];
