...
작성일: 2026-05-14
로컬 경로: `/Users/yeong/99_me/00_github/03_lemon_healthcare/yeong-Vision-Nutrition`
...
커밋 전에는 프로젝트 파일과 로컬 산출물을 반드시 분리해야 한다. `Brand_Character/`, `output/`, `outputs/`, `회의록/`, `../00_plusultra/`는 현재 repo 작업과 별도 산출물로 보이므로 기본 커밋 후보에서 제외한다.
...
- `yeong-Vision-Nutrition/backend/**`
- `yeong-Vision-Nutrition/config/**`
- `yeong-Vision-Nutrition/data/kdris/**`
- `yeong-Vision-Nutrition/data/reference/chronic_nutrient_priorities.json`
- `yeong-Vision-Nutrition/docs/22*`, `23*`, `31*`, `32*`, `33*`, `34*`, `35*`
