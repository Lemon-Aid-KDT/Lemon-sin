...
2. P1-4에서 사용자 확인 저장 API를 구현하고 preview를 `user_supplements`로 승격한다. 이 단계는 구현 완료되었으며 상세 설계는 `docs/previous-version/22-p1-4-supplement-registration-matching.md`를 기준으로 한다.
