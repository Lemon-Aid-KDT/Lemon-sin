...
- [docs/06-tech-stack.md](./06-tech-stack.md) §2.3 — pyproject extras
- [docs/12-local-llm-ollama-migration.md](./12-local-llm-ollama-migration.md) — Ollama 운영 원칙
- [docs/17-image-collection-consent-plan.md](./17-image-collection-consent-plan.md) §6 — 암호화·로컬 운영 정책
- [docs/31-backend-feature-specifications.md](./31-backend-feature-specifications.md) §5 — LLM 모듈 명세
- [docs/33-three-tier-ocr-pipeline-implementation-guide.md](./33-three-tier-ocr-pipeline-implementation-guide.md) — Tier 3 멀티모달 운영안
