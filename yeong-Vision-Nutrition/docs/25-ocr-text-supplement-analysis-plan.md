...
상세 구현 플랜은 `docs/26-ot-s2-ocr-provider-adapter-implementation-plan.md`를 기준으로 한다.
...
- `docs/dev-guides/07-ocr-pipeline.md`에 text attach route와 adapter injection 상태 반영
- `docs/dev-guides/08-llm-supplement-parsing.md`에 endpoint 연결 상태 반영
- `docs/dev-guides/09-supplement-registration-api.md`에 confirmation flow 반영
