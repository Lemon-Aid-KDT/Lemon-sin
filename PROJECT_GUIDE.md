...
5. KDCA key 반영 후 AI Agent strict source gate를 재확인하고, 필요 시 Ollama 서버 재시작 후 `backend/scripts/check_ai_agent_runtime_prereqs.py --require-ollama --require-ollama-parser-smoke`로 개발용 Ollama live parser path를 재확인한다.
