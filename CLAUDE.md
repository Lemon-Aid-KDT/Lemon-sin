...
> 📖 **상세 사례**: [docs/Nutrition-docs/10-compliance-checklist.md §10](./docs/Nutrition-docs/10-compliance-checklist.md)
...
| 작업 종류 | 1순위 참조 | 2순위 참조 |
|---------|----------|---------|
| 알고리즘 구현 (v1~v4, BMR, 7-step) | `docs/Nutrition-docs/07-core-algorithm.md` | `docs/Nutrition-docs/dev-guides/0X-*.md` |
| 부족 영양소 진단 / 목적별 분석 | `docs/Nutrition-docs/07-core-algorithm.md` §4 | `docs/Nutrition-docs/09-data-catalog.md` |
| OCR / LLM Adapter | `docs/Nutrition-docs/07-core-algorithm.md` §4.1 | `docs/Nutrition-docs/06-tech-stack.md` §3 |
| FastAPI 라우터 | `docs/Nutrition-docs/06-tech-stack.md` | `backend/CLAUDE.md` |
| DB 스키마 | `docs/Nutrition-docs/06-tech-stack.md` §3.3 | `docs/Nutrition-docs/09-data-catalog.md` §8 |
| KDRIs / 식약처 데이터 | `docs/Nutrition-docs/09-data-catalog.md` | `data/CLAUDE.md` |
| 사용자 노출 텍스트 (UI/에러) | `docs/Nutrition-docs/10-compliance-checklist.md` §10 | `docs/Nutrition-docs/03-project-intent.md` |
| 권한·동의 UI | `docs/Nutrition-docs/10-compliance-checklist.md` §5.2 | — |
| 면책 고지 표시 | `docs/Nutrition-docs/10-compliance-checklist.md` §2.3 | — |
| GitHub 협업 (브랜치·커밋·PR) | `docs/05-github-guidelines.md` | — |
| 새 기능 일정 / 누가 할지 | `docs/Nutrition-docs/08-implementation-plan.md` | — |
| 시장·페르소나 컨텍스트 필요 | `docs/Nutrition-docs/03-project-intent.md` | `docs/Nutrition-docs/04-market-research.md` |
...
3. `docs/Nutrition-docs/dev-guides/01-bmi-and-v1-algorithm.md` 의 명세 따라 구현
...
Reference:
    docs/Nutrition-docs/07-core-algorithm.md §3.2
"""
...
- 알고리즘 명세: [docs/Nutrition-docs/07-core-algorithm.md](./docs/Nutrition-docs/07-core-algorithm.md)
- 기술 스택: [docs/Nutrition-docs/06-tech-stack.md](./docs/Nutrition-docs/06-tech-stack.md)
- 컴플라이언스: [docs/Nutrition-docs/10-compliance-checklist.md](./docs/Nutrition-docs/10-compliance-checklist.md)
- GitHub 규칙: [docs/05-github-guidelines.md](./docs/05-github-guidelines.md)
- 데이터 카탈로그: [docs/Nutrition-docs/09-data-catalog.md](./docs/Nutrition-docs/09-data-catalog.md)
