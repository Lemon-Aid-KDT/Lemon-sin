param(
    [int]$Batch = 48,
    [int]$Epochs = 50,
    [string]$RunName = "exp04_yolov8n_minorityaug_train500_val100_pc1"
)

[Console]::OutputEncoding = [System.Text.Encoding]::UTF8
$OutputEncoding = [System.Text.Encoding]::UTF8

# Train YOLOv8n on minority-augmented train data and capped validation data.
...
$trainCache = "C:\Lemon-sin\data\food_images\processed\aihub_yolo_50_minority_aug_train500_val100\train\labels.cache"
$valCache = "C:\Lemon-sin\data\food_images\processed\aihub_yolo_50_minority_aug_train500_val100\val\labels.cache"
...
$archive = "C:\Lemon-sin\data\food_images\processed\aihub_yolo_50_minority_aug_train500_val100\_archive_cache"
...
$datasetRoot = "C:\Lemon-sin\data\food_images\processed\aihub_yolo_50_minority_aug_train500_val100"
