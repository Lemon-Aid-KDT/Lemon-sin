"""taxo62 -> balanced (train<=500 / val<=100, seed=42 고정 랜덤) 다운샘플.
...
SRC = Path(r"C:\Lemon-sin\data\food_images\processed\aihub_yolo_taxo62")
DST = Path(r"C:\Lemon-sin\data\food_images\processed\aihub_yolo_taxo62_bal500")
SEED = 42
