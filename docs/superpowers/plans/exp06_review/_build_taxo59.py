"""taxonomy v4(59클래스) 데이터셋 빌드.

exp10용: mala-hot-pot·sweet-and-sour-pork·stir-fried-pork _DROP(AP0.24~0.44 불가·SS보강불가).
...
usage:
    python _build_taxo59.py --dry      # 클래스/물량만 검증, 파일 미생성
    python _build_taxo59.py            # 실제 빌드
"""
...
DST = Path(r"C:\Lemon-sin\data\food_images\processed\aihub_yolo_taxo59")
MAP_CSV = Path(r"C:\Lemon-sin\docs\superpowers\plans\exp06_review\exp10_taxonomy_v4_mapping.csv")
