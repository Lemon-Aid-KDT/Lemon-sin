"""taxo59 -> balanced(cap1500) (train<=500 / val<=100, seed=42 고정 랜덤) 다운샘플.
...
SRC = Path(r"C:\Lemon-sin\data\food_images\processed\aihub_yolo_taxo59")
DST = Path(r"C:\Lemon-sin\data\food_images\processed\aihub_yolo_taxo59_bal1500")
SEED = 42
CAPS = {"train": 1500, "val": 100}  # exp11: train cap 1500(과적합 검증), val은 동일 유지
