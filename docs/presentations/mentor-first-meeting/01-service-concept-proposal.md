...
만성질환은 단기간에 끝나는 문제가 아니라 생활습관, 복약, 검사값을 꾸준히 관리해야 하는 건강 상태다. 대표적으로 고혈압, 당뇨병, 이상지질혈증은 식단, 체중, 활동량, 복약 지속성과 밀접하게 연결된다.

따라서 Lemon Aid는 질환을 진단하거나 치료하는 서비스가 아니라, 사용자의 음식·영양제·복약·활동 기록을 함께 정리해 오늘의 관리 방향을 이해하도록 돕는 건강관리 보조 서비스로 정의한다.
