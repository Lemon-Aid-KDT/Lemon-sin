...
```
03_lemon_healthcare/
├── .github/                         # GitHub 협업 설정은 repo 루트에 유지
...
- **GitHub 협업 설정은 루트 유지**: `.github/`는 `03_lemon_healthcare/.github/`에 두고, workflow와 CODEOWNERS는 `03_lemon_healthcare/yeong-Lemon-Aid/**` 경로를 바라본다.
...
- 트리거: `03_lemon_healthcare/yeong-Lemon-Aid/backend/**`, `03_lemon_healthcare/yeong-Lemon-Aid/data/nutrition_reference/**`, `03_lemon_healthcare/yeong-Lemon-Aid/data/supplement_images/**`, `03_lemon_healthcare/yeong-Lemon-Aid/data/food_images/**`, `03_lemon_healthcare/yeong-Lemon-Aid/config/**` 변경 시
- Python 3.13 환경
...
- 트리거: `03_lemon_healthcare/yeong-Lemon-Aid/mobile/**` 변경 시
- Flutter 안정 버전 환경
...
- 트리거: `03_lemon_healthcare/yeong-Lemon-Aid/docs/**`, `03_lemon_healthcare/yeong-Lemon-Aid/**/*.md` 변경 시
