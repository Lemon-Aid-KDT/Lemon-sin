...
> 🔍 **출처**: [docs/Nutrition-docs/13-algorithm-literature-evidence.md](../13-algorithm-literature-evidence.md), Ollama 공식 Structured Outputs / Chat API 문서.
...
Reference:
    docs/Nutrition-docs/10-compliance-checklist.md §10
"""
