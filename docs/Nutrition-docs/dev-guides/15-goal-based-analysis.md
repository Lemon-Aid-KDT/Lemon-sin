...
> 🔍 **출처**: [docs/Nutrition-docs/07-core-algorithm.md §4.4](../07-core-algorithm.md), [docs/Nutrition-docs/13-algorithm-literature-evidence.md](../13-algorithm-literature-evidence.md), 식약처·식품안전나라 건강기능식품 인정 기능성
...
### 1. `data/nutrition_reference/nutrient/health_goals.json`
...
GOALS_PATH: Final[Path] = Path("data/nutrition_reference/nutrient/health_goals.json")
...
- [ ] `data/nutrition_reference/nutrient/health_goals.json` — 7가지 목적 완전 정의
...
- [`/docs/Nutrition-docs/07-core-algorithm.md §4.4`](../07-core-algorithm.md)
