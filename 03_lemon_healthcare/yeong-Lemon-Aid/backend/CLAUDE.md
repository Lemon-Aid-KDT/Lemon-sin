...
- 모든 비즈니스 로직 (알고리즘 v1~v4, BMR, TDEE, 7-step, 부족 영양소 진단)
...
├── test_bmi.py
├── test_activity.py        # v1, v2, v3, v4
├── test_metabolism.py      # BMR, TDEE
└── test_prediction.py      # 7-step
```
...
```
1. docs/Nutrition-docs/07-core-algorithm.md 에서 명세 확인
2. (있다면) docs/Nutrition-docs/dev-guides/0X-*.md 에서 상세 가이드 확인
3. Nutrition-backend/tests/unit/{module}/test_{name}.py 먼저 작성 (TDD)
   - 회사 가이드 예시를 케이스로
4. Nutrition-backend/src/{module}/{name}.py 구현
5. pytest Nutrition-backend/tests/unit/{module}/test_{name}.py -v 통과
6. mypy --explicit-package-bases Nutrition-backend/src/{module}/{name}.py --strict 통과
7. black + ruff 적용
...
- [`/docs/Nutrition-docs/06-tech-stack.md`](../docs/Nutrition-docs/06-tech-stack.md) — 기술 스택 의사결정
- [`/docs/Nutrition-docs/07-core-algorithm.md`](../docs/Nutrition-docs/07-core-algorithm.md) — 알고리즘 명세
- [`/docs/Nutrition-docs/dev-guides/`](../docs/Nutrition-docs/dev-guides/) — 작업 단위 가이드
