            ...
            "predictions": [
                {
                    ...
                    "corrected_change_kg": -0.189,
                    "predicted_weight_kg": 67.81,
                    "warning": None,
                },
                {
                    "days": 30,
                    ...
                    "corrected_change_kg": -0.811,
                    "predicted_weight_kg": 67.19,
                    "warning": None,
                },
                {
                    "days": 90,
                    ...
                    "corrected_change_kg": -2.434,
                    "predicted_weight_kg": 65.57,
                    "warning": "90일 이상 예측은 대사 적응을 반영하는 동적 모델 검토가 필요합니다.",
                },
            ],
            "evidence_level": "B",
...
SUPPLEMENT_ANALYSIS_RESPONSE_EXAMPLES = {
    "requires_confirmation": {
        ...
        "value": {
            ...
            "layout_fallback_reason": "image_intake_only",
            "label_sections": [],
            "intake_method": {
                "text": None,
                "structured": {
...
SUPPLEMENT_IMPACT_PREVIEW_REQUEST_EXAMPLES = {
    "all_active_supplements": {
        "summary": "Preview all active supplements",
        "value": {
            "selected_supplement_ids": [],
