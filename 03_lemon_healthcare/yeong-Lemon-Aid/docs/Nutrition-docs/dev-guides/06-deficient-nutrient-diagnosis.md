...
│   └── data/                      # data/nutrition_reference/mfds/unit_conversions.json 매핑
└── tests/
    ├── unit/nutrition/
...
> 🔍 **출처**: [docs/Nutrition-docs/07-core-algorithm.md §4.3](../07-core-algorithm.md), [docs/Nutrition-docs/13-algorithm-literature-evidence.md](../13-algorithm-literature-evidence.md)
...
### 단위 환산 규칙 (`data/nutrition_reference/mfds/unit_conversions.json`)
...
Reference:
    docs/Nutrition-docs/09-data-catalog.md §3.4 (단위 환산)
    data/nutrition_reference/mfds/unit_conversions.json
"""
...
CONVERSIONS_PATH: Final[Path] = Path("data/nutrition_reference/mfds/unit_conversions.json")
"""단위 환산 룰 JSON 경로."""
...
def generate_message(
    ...
    Reference:
        docs/Nutrition-docs/10-compliance-checklist.md §10 (표현 가이드)
    """
    match status:
...
- [ ] `data/nutrition_reference/mfds/unit_conversions.json` — 비타민 A/D/E 환산 룰
