...
## 1단계: 기획·합의 문서
- docs/01-product-vision-and-strategy.md
- docs/02-personas-and-scenarios.md
- docs/03-feature-and-output-spec.md
- docs/04-success-metrics-and-differentiation.md

## 2단계: 협업 시스템
- docs/05-collaboration-charter.md
- .github/ (PR/Issue 템플릿, CODEOWNERS, Branch 정책)

## 3단계: 실행 설계
- docs/06-tech-stack.md (외부 API, 라이브러리 의사결정 근거)
- docs/07-core-algorithm.md (BMI, BMR, KDRIs, Hall, 활동점수 v1~v4)
- docs/08-roadmap.md (Phase 1~4 일정)

## 추가 문서
- docs/09-data-catalog.md (데이터 출처·라이선스·갱신 주기)
- docs/10-compliance-checklist.md (의료법·약사법·건기식법·개인정보)
...
### Day 1 (1시간)
1. README.md (전체 개요)
2. docs/01-product-vision (왜 만들었나)
3. docs/03-feature-and-output-spec (5종 출력)

### Day 2-3 (3시간)
4. docs/06-tech-stack (왜 이 기술)
5. docs/07-core-algorithm (어떻게 계산)
6. docs/10-compliance-checklist (안전성)
...
### 식약처 인정 원료
- 위치: `data/mfds/functional_ingredients.csv`
- 라이선스: 식약처 공공데이터
...
### 건강 목적 정의
- 위치: `data/reference/health_goals.json`
...
### 인계 직전 검증
- [ ] DB 스키마 docs/09-data-catalog.md와 일치
