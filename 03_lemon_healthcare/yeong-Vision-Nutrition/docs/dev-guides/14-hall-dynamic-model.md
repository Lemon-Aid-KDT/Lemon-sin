...
> 🔍 **출처**: [docs/07-core-algorithm.md §6.1](../07-core-algorithm.md), [docs/13-algorithm-literature-evidence.md](../13-algorithm-literature-evidence.md), Hall et al. (2011) "Quantification of the effect of energy imbalance on bodyweight.", NIDDK Body Weight Planner 공식 문서와 Hall Lancet web appendix.
