...
- `docs/09-data-catalog.md`
- `docs/10-compliance-checklist.md`
- `docs/11-detailed-feature-implementation-plan.md`
- `docs/12-local-llm-ollama-migration.md`
- `docs/14-pre-implementation-scope-and-rules.md`
- `docs/15-regulated-feature-feasibility-and-compliance-plan.md`
- `docs/dev-guides/00-setup-environment.md`
- `docs/dev-guides/07-ocr-pipeline.md`
- `docs/dev-guides/08-llm-supplement-parsing.md`
- `docs/dev-guides/09-supplement-registration-api.md`
- `docs/dev-guides/12-mobile-healthkit-integration.md`
- `docs/dev-guides/26-operations-manual.md`
- `docs/dev-guides/27-incident-runbook.md`
...
| `docs/dev-guides/00-setup-environment.md` | Settings 예시에 `anthropic_api_key`가 있고 Ollama, CLOVA, regulated feature 설정이 부족했음 | Ollama, CLOVA, 처방전 OCR, 검사표 OCR, 복용량 변경 차단 feature flag를 반영 |
| `docs/08-implementation-plan.md` | 이전 MVP 제외 범위와 외부 LLM 흐름이 일부 남아 있음 | 병원 데이터는 mock FHIR/수동 업로드/API 후보, 처방전·검사표는 OCR intake로 단계화 |
...
3. `docs/12-local-llm-ollama-migration.md` 기준으로 Ollama 모델 실행 가능 여부를 확인한다.
