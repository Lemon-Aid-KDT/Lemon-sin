...
> 작성일: 2026-05-15
> 상태: 구현 완료
> 대상: root `.github/PULL_REQUEST_TEMPLATE.md`, project-local `03_lemon_healthcare/.github/PULL_REQUEST_TEMPLATE.md`, `docs/23`, `docs/dev-guides/30`
...
| `data/kdris/**` | 적용 | KDRIs 분석 기준 영향 |
| `data/reference/**` | 적용 | 만성질환 우선순위, nutrient reference 영향 |
...
- `docs/**` 아래 sign-off 문서
- `output/todo-list/**` 아래 팀 공유 sign-off 기록
...
- `docs/36-post-p1-execution-plan.md`
- `docs/dev-guides/30-post-p1-execution-checklist.md`
...
```bash
rg -n "[[:blank:]]$" .github/PULL_REQUEST_TEMPLATE.md 03_lemon_healthcare/.github/PULL_REQUEST_TEMPLATE.md 03_lemon_healthcare/yeong-Vision-Nutrition/docs/38-stabilization-pr-gate-design-plan.md
```
