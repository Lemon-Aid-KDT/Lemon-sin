...
| Current guide | `docs/dev-guides/08-llm-supplement-parsing.md` | 현재 구현 설명 |
...
- docs/dev-guides/08의 테스트 파일명 불일치를 보정한다.
...
| `docs/dev-guides/08-llm-supplement-parsing.md` | 이 계획 문서 링크와 현재 테스트 파일명 보정. |
| `docs/12-local-llm-ollama-migration.md` | 현행 구현 기준과 이 세부 계획 링크 추가. |
