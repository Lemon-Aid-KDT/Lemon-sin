# 2026-05-23 CLOVA Phase 0 Baseline Approved Rerun Result

## Scope

사용자 외부 전송 승인 후 16개 chronic fixture 이미지를 NAVER CLOVA OCR에
전송해 redacted Phase 0 baseline을 재생성했다.

## Runtime

- Work root: `03_lemon_healthcare/Lemon-Aid`
- Provider: `clova_ocr`
- Manifest: `outputs/generated/ocr-eval/2026-05-23-stage1-clova-approved/manifest-with-clova-observations.jsonl`
- Fixture image root env: `SUPPLEMENT_OCR_FIXTURE_ROOT`
- Output dir: `outputs/generated/ocr-eval/2026-05-23-stage1-clova-approved/`
...
- observation JSONL과 evaluator manifest는 forbidden raw key 재귀 스캔을
  통과했다.
- 새 `2026-05-23-stage1-clova-approved` 산출물은 `.gitignore`에 의해
  ignored 상태다.
...
- 1건은 raw 없이 `ocr_error`만 남았으므로, 필요하면 operator가 해당 fixture만
  별도 live smoke로 재시도한다.
