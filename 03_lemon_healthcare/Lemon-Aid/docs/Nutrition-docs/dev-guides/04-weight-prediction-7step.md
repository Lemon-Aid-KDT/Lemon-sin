...
> 🔍 **출처**: [docs/Nutrition-docs/07-core-algorithm.md §3.8](../07-core-algorithm.md), [docs/Nutrition-docs/13-algorithm-literature-evidence.md](../13-algorithm-literature-evidence.md)
...
class WeightPrediction(BaseModel):
    ...
    Reference:
        docs/Nutrition-docs/07-core-algorithm.md §3.8
    """
