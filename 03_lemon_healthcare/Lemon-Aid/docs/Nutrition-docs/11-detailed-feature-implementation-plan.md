...
- `data/nutrition_reference/kdris/kdris_metadata.json`
- `data/nutrition_reference/nutrient/nutrient_codes.json`
...
- `data/nutrition_reference/nutrient/health_goals.json`
