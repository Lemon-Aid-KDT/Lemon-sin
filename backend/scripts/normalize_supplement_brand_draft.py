...
KNOWN_BRANDS = [
    "종근당건강", "내츄럴플러스", "뉴트리코스트", "블루보넷뉴트리션", "닥터스베스트",
    "자로우포뮬러스", "라이프익스텐션", "네츄럴펙터스", "네이처스웨이", "스포츠리서치",
    "파라다이스허브", "이노빅스랩스", "캘리포니아골드뉴트리션", "바디닥터스", "닥터프로그램",
    "닥터에디션", "쏜리서치", "고려은단", "굿앤키즈", "나우푸드", "뉴트리코어", "에스더포뮬러",
    "닥터린", "유한양행", "프롬바이오", "삼대오백", "세노비스", "센트룸", "락티브", "락토핏",
    "리포데이", "얼라이브", "에버핏", "써큐란", "덴프스", "아임비타", "데일리원", "안국건강",
    "한미양행", "광동제약", "대웅제약", "동국제약", "뉴트리원", "GNM", "솔가", "나우", "쏜",
    "종근당", "YDY", "헬스밸런스", "BNF", "비타민하우스", "주영엔에스",
]
...
NOISE_TOKENS = {
    "마시는", "미국산", "국내산", "수용성", "지용성", "식물성", "동물성", "유기농", "유통기한",
    "원스데일리", "데일리", "메가", "에너지", "아르기닌", "조인트", "알부민", "종합", "고함량",
    "프리미엄", "초임계", "저분자", "활성형", "고흡수", "어린이", "키즈", "임산부", "남성", "여성",
}
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(json.dumps({k: summary[k] for k in (
        "product_count", "distinct_proposed_brands", "high_confidence_count",
        "needs_human_review_count", "resolution_method_counts")}, ensure_ascii=False, indent=2))
    return 0
