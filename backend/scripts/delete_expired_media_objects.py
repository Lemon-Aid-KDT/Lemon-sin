"""Delete expired backend-only media objects without leaking object details."""
...
from src.media.retention import delete_expired_media_objects  # noqa: E402
...
async def run_cli(argv: list[str] | None = None) -> int:
    """Delete expired media objects with sanitized operator output.
    ...
    parser.add_argument(
        ...
        type=_bounded_limit,
        default=100,
        help=f"Maximum expired media objects to delete ({MIN_LIMIT}-{MAX_LIMIT}).",
    )
