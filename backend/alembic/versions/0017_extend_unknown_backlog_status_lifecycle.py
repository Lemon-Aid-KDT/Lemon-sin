...
Revision ID: 0017_extend_unknown_backlog_status_lifecycle
Revises: 0016_seed_lithium_supplement_boundary
...
revision: str = "0017_extend_unknown_backlog_status_lifecycle"
down_revision: str | Sequence[str] | None = "0016_seed_lithium_supplement_boundary"
